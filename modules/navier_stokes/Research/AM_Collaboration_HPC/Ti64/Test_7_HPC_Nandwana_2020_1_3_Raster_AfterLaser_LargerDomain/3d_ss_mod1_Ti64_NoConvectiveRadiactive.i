...
period = 1.0 # Period of the laser motion  # 1.25e-3  5.00e-1 10.6e-1  Dwell time = 160 mus, simulation time = 320 mus   800e-6
...
[Functions]
  ...
  [path_y]
    type = ParsedFunction
    expression = "15e-3" # 2*sin(2.0*pi*t)   0  0.0012  
  []
  [path_z]
    type = ParsedFunction
