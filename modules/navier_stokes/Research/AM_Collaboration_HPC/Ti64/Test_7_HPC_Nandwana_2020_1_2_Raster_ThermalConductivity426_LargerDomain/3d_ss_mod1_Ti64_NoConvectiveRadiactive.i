...
[Mesh]
  [gen] 
    ...
    zmin = 0e-3
    zmax = 25.0e-3 # 0.5e-3   1.5e-3  4.5e-3 
    nx = 15  # 2  10 40
    ny = 15 # 6  10 8
    nz = 25  # 2  5 4
  []
...
[Functions]
  ...
  [path_x]
    type = ParsedFunction
    expression = "4.550e-3*t + 6.5e-3" # 2*cos(2.0*pi*t) 8.47e-3*t  6.35e-3*t  10.58e-3*t  "8.47e-3*t + 0.01"  "8.47e-3*t + 2.1175e-3"
  []
  [path_y]
    type = ParsedFunction
  ...
  [path_z]
    type = ParsedFunction
    expression = "25e-3" # 1 0.001 0.0012 0.0008 0.00115 0.00125  0.01025
  []
[]
