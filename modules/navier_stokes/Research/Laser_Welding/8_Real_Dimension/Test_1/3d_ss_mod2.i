...
# v_laser = 8.47e-3  # velocity of the laser motion in m/s (fixed for simplicity, can be a function of time if needed)
...
[BCs]
  ...
  [weld_flux]  # boundary condition for laser heat flux at the front (z=max) boundary
    ...
    x_beam_coord = '4e-3*t/${endtime}'  # x coordinate of the laser beam center (moving in x direction over time)
