period = 10.00e-1 # Period of the laser motion  # 1.25e-3  5.00e-1
...
[BCs]
  ...
  [weld_flux]  # boundary condition for laser heat flux at the front (z=max) boundary
    ...
    x_beam_coord = '10.0e-3*t/${endtime} + 1.0e-3'  # x coordinate of the laser beam center (moving in x direction over time) Scan Speed = 4.5e-3/${endtime}
