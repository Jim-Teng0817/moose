...
[BCs]
  ...
  [weld_flux]  # boundary condition for laser heat flux at the front (z=max) boundary
    ...
    y_beam_coord = '1.50e-3'              # y coordinate of the laser beam center (fixed in y direction)  '0.25e-3'  '0.75e-3'
    z_beam_coord = '1.50e-3'              # z coordinate of the laser beam center (fixed in z direction)  '0.5e-3' 
