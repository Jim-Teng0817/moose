...
[Functions]
  [path_x]
    type = ParsedFunction
    expression = "8.47e-3*t + 2.1175e-3" # 2*cos(2.0*pi*t) 8.47e-3*t  6.35e-3*t  10.58e-3*t  "8.47e-3*t + 0.01"
  []
  [path_y]
    type = ParsedFunction
    expression = 2.00e-3 # 2*sin(2.0*pi*t)   0  0.0012  
  []
  [path_z]
    type = ParsedFunction
    expression = 2.00e-3 # 1 0.001 0.0012 0.0008 0.00115 0.00125  0.01025
  []
