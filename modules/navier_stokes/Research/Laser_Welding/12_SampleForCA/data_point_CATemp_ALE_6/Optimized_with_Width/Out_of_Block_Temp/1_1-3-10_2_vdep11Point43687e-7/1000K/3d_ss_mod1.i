...
Effective_Laser_Power = 75                # Laser Power * Laser Absorption Efficiency      250*0.3=75, 300*0.3=90, 350*0.3=105
Laser_Scan_Speed = 6.35e-3  # Laser Scan Speed in m/s  # 8.47e-3 6.35e-3 10.58e-3 
Powder_Feeding_Rate = 17.95  # Powder Feeding Rate in g/min  # 1.21 3.07 4.93 6.79 8.65 10.51 12.37 14.23 16.09 17.95
Start_Point_X = 6.0e-3  # Starting X coordinate of the laser beam in m
Deposition_Parameter = 11.43687e-7  # Deposition velocity in m/s  # 150e-3  5e-3  5e-8  
Smooth_Parameter = 200        # Transition Boundary to Deform or Not to Deform
OB_Temp_i = 1000              # Out-of-Block Temperature
...
[VectorPostprocessors]
  [point_value_vector_postprocessor_u]
    ...
    samples_file = data_points_CATemp_ALE_6.csv     #  only for modified code for reading CSV File      data_points_test.csv
