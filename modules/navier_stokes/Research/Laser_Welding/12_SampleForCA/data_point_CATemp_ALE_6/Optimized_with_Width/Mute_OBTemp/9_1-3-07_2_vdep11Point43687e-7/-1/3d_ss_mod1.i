...
Powder_Feeding_Rate = 12.37  # Powder Feeding Rate in g/min  # 1.21 3.07 4.93 6.79 8.65 10.51 12.37 14.23 16.09 17.95
...
[BCs]
  ...
  [weld_flux]  # boundary condition for laser heat flux at the front (z=max) boundary
    ...
    P0 = 75                               # Peak power of the laser in W  159.96989792079225  120  250 * 30% = 75W
