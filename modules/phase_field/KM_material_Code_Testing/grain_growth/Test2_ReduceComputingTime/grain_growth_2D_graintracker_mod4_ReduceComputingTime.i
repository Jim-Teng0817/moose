...
K_m = 1.8e2                                     # GB mobility parameter.  # For reducing the computing time (1.8e4 -> 1.8e2) (Jim May 28, 2026)
...
dt_i = 1e1                 # 1e-2                     # For reducing the computing time (1e-5 -> 1e1) (Jim May 28, 2026)
end_time_i = '${fparse 0.72 * (1/time_scale_i)}'       # For reducing the computing time (7200 -> 0.72) (Jim May 28, 2026)
...
[Mesh]
  ...
  nx = 88 # 220 44   Number of elements in the x-direction
  ny = 88 # 220 44   Number of elements in the y-direction
  xmax = 1000 # 10000 11650 550   55e-6 m = 55000 nm = 550e-7   # 1000 # maximum x-coordinate of the mesh
  ymax = 1000 # 10000 11650 550   55e-6 m = 55000 nm = 550e-7   # 1000 # maximum y-coordinate of the mesh
