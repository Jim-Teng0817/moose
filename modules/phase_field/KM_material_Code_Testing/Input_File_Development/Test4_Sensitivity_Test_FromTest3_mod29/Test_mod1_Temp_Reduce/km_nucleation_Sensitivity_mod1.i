...
nuc_radius_i = 80.0         # radius in mesh length units; start around one initial element  # 4.0
...
[Outputs]
  ...
  []
  exodus = true
  file_base = ${Folder_name}/${T_i}K/mod${mod_num}_${input_text_file}
[]
