...
# stage          = 00_mask_width
# parameter_set  = window_medium_iw_8
# case_name      = window_medium_bmin_0p55_bmax_0p85_iw_8p0
# Submit from the package root with:
#   sbatch submit_one_case.slurm cases/00_mask_width/window_medium_bmin_0p55_bmax_0p85_iw_8p0/input.i
# -----------------------------------------------------------------------------
...
# Filename
Folder_name = 'cases/00_mask_width/window_medium_bmin_0p55_bmax_0p85_iw_8p0'
mod_num = window_medium_bmin_0p55_bmax_0p85_iw_8p0
