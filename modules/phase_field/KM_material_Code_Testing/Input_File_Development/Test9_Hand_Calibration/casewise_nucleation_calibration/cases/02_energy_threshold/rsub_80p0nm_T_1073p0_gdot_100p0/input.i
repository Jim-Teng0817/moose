...
# parameter_set  = rsub_80nm
# case_name      = rsub_80p0nm_T_1073p0_gdot_100p0
# Submit from the package root with:
#   sbatch submit_one_case.slurm cases/02_energy_threshold/rsub_80p0nm_T_1073p0_gdot_100p0/input.i
# -----------------------------------------------------------------------------
...
# Filename
Folder_name = 'cases/02_energy_threshold/rsub_80p0nm_T_1073p0_gdot_100p0'
mod_num = rsub_80p0nm_T_1073p0_gdot_100p0
