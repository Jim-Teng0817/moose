...
# case_name      = seed_12345_T_873p0_gdot_0p1
# Submit from the package root with:
#   sbatch submit_one_case.slurm cases/04_validation/seed_12345_T_873p0_gdot_0p1/input.i
# -----------------------------------------------------------------------------
...
nuc_prob_i = 0.002
seed_i = 12345                # 12345 23456
T_i = 873

# Filename
Folder_name = 'cases/04_validation/seed_${seed_i}_T_${T}_gdot_0p1'
mod_num = seed_${seed_i}_T_${T}_gdot_0p1
