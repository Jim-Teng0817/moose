...
# parameter_set  = rsub_60nm
# case_name      = rsub_60p0nm_T_873p0_gdot_1000p0
# Submit from the package root with:
#   sbatch submit_one_case.slurm cases/02_energy_threshold/rsub_60p0nm_T_873p0_gdot_1000p0/input.i
# -----------------------------------------------------------------------------
...
# Filename
Folder_name = 'cases/02_energy_threshold/rsub_60p0nm_T_873p0_gdot_1000p0'
mod_num = rsub_60p0nm_T_873p0_gdot_1000p0
