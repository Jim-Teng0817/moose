...
nuc_radius_i = 30.0         # radius in mesh length units; start around one initial element  # 4.0
...
nuc_prob_i = 2.0e-3         # stochastic insertion probability/rate density   # 1.0e-4 5.0e-4
