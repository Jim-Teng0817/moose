...
# Strain Rate
strain_rate_i = 1e3         # Strain Rate in 1/s  1e-1 1e0 1e1 1e2 1e3
total_strain_i = 10
end_time_i = '${fparse total_strain_i / strain_rate_i}'    # 10
...
# Filename
Folder_name = 'Output/'
mod_num = 4_t1_Pnuc2e-3_GBmob1e-5_rhoBasedPnuc_w25_1073K
...
int_width_i = 25.0            # GB interface width for new formed grains (in length scale) # 2.0 40.0 10.0 25.0
