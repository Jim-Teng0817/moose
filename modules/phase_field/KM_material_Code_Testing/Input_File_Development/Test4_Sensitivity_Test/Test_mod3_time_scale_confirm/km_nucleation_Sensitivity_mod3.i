...
# Filename
Folder_name = 'Output/'
mod_num = 3_KMtest_time1e0_CC_Pnuc2e3_rhoi1e16_width10_2
...
nuc_prob_i = 2.0e3         # stochastic insertion probability/rate density   # 1.0e-4 5.0e-4 2.0e-3
...
int_width_i = 10.0            # GB interface width for new formed grains (in length scale) # 2.0 40.0 10.0
...
wGB_i = 10.0                 # GB width for initial grains (in length scale) # 4.0 40.0 10.0
molar_volume_i = 1.21e-5     # Molar volume in m^3/mol, needed for temperature gradient driving force
GBmob0_i = 1.532e-5          # Pre-factor for Grain Growth based mobility
...
T_i = 1073                   # Initial / Input Temperature in K  873, 973, 1073, 1173, 1273 K
...
# Strain Rate
strain_rate_i = 1e-1         # Strain Rate in 1/s  1e-1 1e0 1e1 1e2 1e3
...
[Outputs]
  ...
  []
  exodus = true
  file_base = ${Folder_name}/${strain_rate_i}/mod${mod_num}_${input_text_file}
[]
