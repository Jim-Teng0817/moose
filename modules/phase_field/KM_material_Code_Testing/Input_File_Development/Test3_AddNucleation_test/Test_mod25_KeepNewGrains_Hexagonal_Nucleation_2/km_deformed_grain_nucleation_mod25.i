...
int_width_i = 20.0            # GB interface width for new formed grains (in length scale) # 2.0 40.0
...
wGB_i = 20.0                 # GB width for initial grains (in length scale) # 4.0 40.0
