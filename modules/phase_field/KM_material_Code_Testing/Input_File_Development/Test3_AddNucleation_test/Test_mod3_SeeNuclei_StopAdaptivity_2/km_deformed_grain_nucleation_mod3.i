...
nuc_radius_i = 10.0         # radius in mesh length units; start around one initial element  # 4.0
rho_crit_i = 5e-4           # m^-2; tune after checking rho_grain output. # 5.0e14
nuc_prob_i = 1.0e-3         # stochastic insertion probability/rate density   # 1.0e-4
...
[Materials]
  ...
  [nucleation_probability]             # Added for Nucleation (Jim June 17, 2026)
    ...
    # expression = 'if(rho_eff > rho_crit, if(bnds > bnds_min, P0, 0), 0)'
