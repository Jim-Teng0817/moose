...
nuc_radius_i = 120.0         # radius in mesh length units; start around one initial element  # 4.0
...
nuc_prob_i = 5.0e-4         # stochastic insertion probability/rate density   # 1.0e-4 5.0e-4
...
# Nucleation Force
nuc_strength_i = 300.0       # Nucleation Force, here adjust for making bnds 1 # 200
