...
# Filename
Folder_name = 'Output/'
mod_num = 27_2_lower_nuc_prob_2e-3
...
# bnds = sum eta_i^2
# grain interior: bnds ~ 1
# grain boundary: bnds < 1
# 0.75 matches your old C++ code; use 0.65 or 0.60 for narrower GB nucleation.
...
# Nucleation Force
nuc_strength_i = 400.0       # Nucleation Force, here adjust for making bnds 1 # 200

# Nucleated Grain Width
int_width_i = 50.0            # GB interface width for new formed grains (in length scale) # 2.0
...
wGB_i = 50.0                 # GB width for initial grains (in length scale) # 4.0
...
[AuxVariables]
  ...
  []
  [T]
    initial_condition = 1073    # 1073.0 393
  []
  [rho_grain]
    family = MONOMIAL
    order = CONSTANT
