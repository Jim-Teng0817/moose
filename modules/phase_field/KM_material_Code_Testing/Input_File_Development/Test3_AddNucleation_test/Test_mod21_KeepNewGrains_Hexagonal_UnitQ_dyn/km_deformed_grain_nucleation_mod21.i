...
rho_crit_i = 5e-4           # m^-2; tune after checking rho_grain output. # 5.0e14 5e-4 # if target is 5e14 m^-2 = 5e-4 nm^-2     
...
int_width_i = 10.0            # GB interface width for new formed grains (in length scale) # 2.0

GBenergy_i = 0.5             # GB energy in J m^-2    # 0.708 0.5
GBMobility_i = 6.1995e-14    # GB Mobility in m^4 J^-1 s^-1   # 2.5e-14 6.1995e-14
wGB_i = 10.0                  # GB width for initial grains (in length scale) # 4.0
